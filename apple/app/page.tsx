    ...
    <>
      ...
      <div id="main">
        <div id="page1" style={{ width: "100%", position:"relative"}} >
          ...
          <div className="text" style={{position: "absolute", top: "20%", left: "5%"}}>
          <FlipWord />
          </div>
        </div>
        ...
        <MenuItem setActive={setActive} active={active} item="Store">
          <div className="  text-sm grid grid-cols-2 gap-10 p-4">
            <ProductItem
              ...
              src="https://i.ytimg.com/vi/tWD_-Rzrn8o/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLCKhJ0jzHHsjkkzRf8Dz6Lvuz5a5w"
              description="Prepare for tech interviews like never before."
            />
            <ProductItem
              title="Delhi"
              href="https://tailwindmasterkit.com"
              src="https://www.livemint.com/lm-img/img/2023/04/11/1600x900/apple_new_store_1680721899761_1681187553111_1681187553111.jpeg"
